...
clickableElem.addEventListener(
  "click",
  function () {
...
function thirtyHandler() {
  firstTimer.innerHTML = "3:00";
  secondTimer.innerHTML = "3:00";
  initial = 1800;
  first_period = 1800;
  second_period = 1800;
...
function makeBackgroundBlack() {
  clickableElem.style.background =
    "repeating-linear-gradient( -45deg, #ececec, #ececec 5px, rgb(46, 46, 46) 5px, rgb(46, 46, 46) 40px)";
}

function makeBackgroundWhite() {
  clickableElem.style.background =
    "repeating-linear-gradient( -45deg, rgb(88, 88, 88), rgb(88, 88, 88) 5px, rgb(180, 180, 180) 5px, rgb(180, 180, 180) 40px)";
}
